...
import { CalendarDays, Droplets, Beaker, Bug, CloudSun, TrendingUp, IndianRupee } from "lucide-react";
    ...
    <DashboardLayout>
      <div className="space-y-6 animate-fade-up">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Personalized daily farming guidance & profit estimation</p>
        </div>
